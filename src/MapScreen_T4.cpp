...
const MapScreen_ex::geo_map MapScreen_T4::s_maps[] =
{
  ...
  [8] = { .mapData = lily_home_Centre, .png = "/maps/home_middle.png",.label="Home",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2889, .mapLongitudeRight = -0.2866, .mapLatitudeBottom = 51.3912}, // map top 51.3923
  [9] = { .mapData = lily_home_All, .png = "/maps/home_all.png",.label="All",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2951, .mapLongitudeRight = -0.2817, .mapLatitudeBottom = 51.3882, }, // map top 51.3944
