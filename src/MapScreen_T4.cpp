...
{
  [0] = { .mapData = lily_wraysbury_N, .png = "lily_wraysbury_N.png",.label="North", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5503, .mapLongitudeRight = -0.5473, .mapLatitudeBottom = 51.4613}, // -0.5503,51.4613,-0.5473,51.4627
  [1] = { .mapData = lily_wraysbury_W, .png = "lily_wraysbury_W.png",.label="West", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5501, .mapLongitudeRight = -0.5471, .mapLatitudeBottom = 51.4606},  // -0.5501,51.4606,-0.5471,51.462
  [2] = { .mapData = lily_wraysbury_SW, .png = "lily_wraysbury_SW.png",.label="South West", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5494, .mapLongitudeRight = -0.5464, .mapLatitudeBottom = 51.4597}, // 0.5494,51.4597,-0.5464,51.4611
  [3] = { .mapData = lily_wraysbury_S, .png = "lily_wraysbury_S.png",.label="South", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5491, .mapLongitudeRight = -0.5461, .mapLatitudeBottom = 51.4591}, // -0.5491,51.4591,-0.5461,51.4605
  [4] = { .mapData = lily_wraysbury_SE, .png = "lily_wraysbury_SE.png",.label="South East", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.548, .mapLongitudeRight = -0.545, .mapLatitudeBottom = 51.4588}, //  -0.548,51.4588,-0.545,51.4602
  [5] = { .mapData = lily_wraysbury_All, .png = "lily_wraysbury_All.png",.label="All", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5517, .mapLongitudeRight = -0.5437, .mapLatitudeBottom = 51.4588}, //  -0.5517,51.4588,-0.5437,51.4626
  ...
  [8] = { .mapData = lily_home_Centre, .png = "lily_home_Centre.png",.label="Home",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2889, .mapLongitudeRight = -0.2866, .mapLatitudeBottom = 51.3912}, // map top 51.3923
  [9] = { .mapData = lily_home_All, .png = "lily_home_All.png",.label="All",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2951, .mapLongitudeRight = -0.2817, .mapLatitudeBottom = 51.3882, }, // map top 51.3944
  [10] = { .mapData = lily_vobster_Centre, .png = "lily_vobster_Centre.png",.label="Vobster",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -2.4255, .mapLongitudeRight = -2.4202, .mapLatitudeBottom = 51.24465}, // map top 51.2472  origianal bot = 51.2448
  [11] = { .mapData = lily_vobster_All, .png = "lily_vobster_All.png",.label="All",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -2.427, .mapLongitudeRight = -2.4202, .mapLatitudeBottom = 51.2447},  // map top 51.2479

  // old bottom: 51.06601   last: 51.06511112 
  [12] = { .mapData = lily_all_other_areas_Centre, .png = "lily_all_other_areas_Centre.png",.label="Out-To-Sea",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = 1.269333, .mapLongitudeRight = 1.272333, .mapLatitudeBottom = 51.06538078},
 // [13] = { .mapData = lily_all_other_areas_All, .png = "lily_all_other_areas_All.png",.label="All",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = 1.269333, .mapLongitudeRight = 1.272333, .mapLatitudeBottom = 51.06538078},

//  [13] = { .mapData = lily_all_other_areas_All, .png = "lily_all_other_areas_All.png", .label="All", .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = 1.263733, .mapLongitudeRight = 1.278033, .mapLatitudeBottom = 51.06265},
