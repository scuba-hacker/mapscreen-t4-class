...
const MapScreen_ex::geo_map MapScreen_T4::s_maps[] =
{
  ...
  [1] = { .mapData = lily_wraysbury_W, .png = "/maps/lily_wraysbury_W.png",.label="West", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5501, .mapLongitudeRight = -0.5471, .mapLatitudeBottom = 51.4606},  // -0.5501,51.4606,-0.5471,51.462
  [2] = { .mapData = lily_wraysbury_SW, .png = "/maps/lily_wraysbury_SW.png",.label="South West", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5494, .mapLongitudeRight = -0.5464, .mapLatitudeBottom = 51.4597}, // 0.5494,51.4597,-0.5464,51.4611
  [3] = { .mapData = lily_wraysbury_S, .png = "/maps/lily_wraysbury_S.png",.label="South", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5491, .mapLongitudeRight = -0.5461, .mapLatitudeBottom = 51.4591}, // -0.5491,51.4591,-0.5461,51.4605
  [4] = { .mapData = lily_wraysbury_SE, .png = "/maps/lily_wraysbury_SE.png",.label="South East", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.548, .mapLongitudeRight = -0.545, .mapLatitudeBottom = 51.4588}, //  -0.548,51.4588,-0.545,51.4602
  [5] = { .mapData = lily_wraysbury_All, .png = "/maps/lily_wraysbury_all.png",.label="All", .backColour=TFT_BLACK, .backText="", .surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.5517, .mapLongitudeRight = -0.5437, .mapLatitudeBottom = 51.4588}, //  -0.5517,51.4588,-0.5437,51.4626
  ...
  [8] = { .mapData = lily_home_Centre, .png = "/maps/lily_home_Centre.png",.label="Home",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2889, .mapLongitudeRight = -0.2866, .mapLatitudeBottom = 51.3912}, // map top 51.3923
  [9] = { .mapData = lily_home_All, .png = "/maps/lily_home_All.png",.label="All",  .backColour=TFT_BLACK, .backText="",.surveyMap=false, .swapBytes=false, .mapLongitudeLeft = -0.2951, .mapLongitudeRight = -0.2817, .mapLatitudeBottom = 51.3882, }, // map top 51.3944
